...
#
source "$(dirname "${BASH_SOURCE}")/SOFTWARE_INSTALLATION_PREFIX_DIR.source.bash"
source "$(dirname "${BASH_SOURCE}")/${SOFTWARE_INSTALLATION_PREFIX_DIR}/9999 - Commons/Enable strict mode.source.bash"

...
# For some reason non-empty associative array is not considered as "set" by -v test, even though it should
...
init(){
	...
	for parameter in indexed_array indexed_array_null associative_array associative_array_null; do
